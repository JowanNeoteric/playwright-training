export const common = {
	...
	text: {
		...
		sections: {
			...
			brokenLinksImages: {
				broken: {
					clickForEnter: "Click Here for Broken Link",
					link: "Broken Link",
					image: "Broken image"
				},
				valid: {
					clickForEnter: "Click Here for Valid Link",
					link: "Valid Link",
					image: "Valid image"
				}
			},
			...
			dynamicProperties: {
				randomId: "This text has random Id",
				beEnabled: "Will enable 5 seconds",
				colorChange: "Color Change",
				timeVisibility: "Visible After 5 Seconds"
			}
	...
	path: {
		image: {
			valid: "/images/Toolsqa.jpg",
			invalid: "/images/Toolsqa_1.jpg",
		}
	}
};
